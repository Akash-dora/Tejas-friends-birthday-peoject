    ...
    useEffect(() => {
        const timer = setInterval(() => {
            ...
            setTimeLeft({
                ...
                seconds: Math.floor((distance % (1000 * 660)) / 1000),
            })
        }, 1000)
    ...
    return (
        ...
        >
            ...
            >
                ...
                <p className="text-purple-300 text-base">The surprise is just moments away...Let's make your first birthday with me so memorable and joyful 💖</p>
            </motion.div>
        </motion.div>
    )
}
